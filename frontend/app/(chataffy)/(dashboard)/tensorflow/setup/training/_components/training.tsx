  ...
  const getData = () => {
    ...
    socket.on('web-pages-crawled', function (data: any) {
      ...
      setTrainingList((prevTrainingList: any) => ({
        data: prevTrainingList.data.map((item1: any) => ({
          ...item1,
          trainingStatus: indexedData[item1._id] ? 2 : item1.trainingStatus,
        })),
        loading: false,
      }));
    ...
    socket.on('web-pages-minified', function (data: any) {
      ...
      setTrainingList((prevTrainingList:any) => ({
        data: prevTrainingList.data.map((item1: any) => ({
          ...item1,
          trainingStatus: indexedData[item1._id] ? 3 : item1.trainingStatus,
        })),
        loading: false,
      }));
    ...
    socket.on('web-pages-mapped', function (data: any) {
      ...
      setTrainingList((prevTrainingList:any) => ({
        data: prevTrainingList.data.map((item1: any) => ({
          ...item1,
          trainingStatus: indexedData[item1._id] ? 4 : item1.trainingStatus,
        })),
        loading: false,
      }));
