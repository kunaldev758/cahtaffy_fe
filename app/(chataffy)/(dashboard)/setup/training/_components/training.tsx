...
export default function EnhancedTrainingPage() {
  ...
  const selectAllTimeoutRef = useRef<number | null>(null)
      ...
      <div className="rounded-tl-[30px] bg-[#F3F4F6] px-4 pb-[33px] pt-6 lg:px-6 flex flex-col gap-6 h-[calc(100%-89px)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="rounded-[20px] bg-white p-[20px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.02)]">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#EAFFEA] rounded-lg flex items-center justify-center">
                  <span className="material-symbols-outlined text-[#399E39] !text-[20px]">
                    description
                  </span>
                </div>
                <div>
        ...
        {/* ── Table Card ── */}
        <div className="rounded-[20px] bg-white shadow-[0px_4px_20px_0px_rgba(0,0,0,0.02)] overflow-hidden">

          {/* Toolbar */}
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 p-[20px] border-b border-[#F1F5F9]">
            {/* Search */}
          ...
          <Table className="w-full">
            <TableHeader>
              <TableRow className="bg-[#F8FAFC] border-b border-[#F1F5F9] hover:bg-[#F8FAFC] h-[44px]">
            ...
            <TableBody>
              {trainingList.loading ? (
                Array.from({ length: 7 }).map((_, i) => (
                  <TableRow key={i} className="h-[50px] hover:bg-[#F8FAFC]">
                    <TableCell className=" min-w-[36px] !px-[20px] text-left">
                  ...
                  return (
                    <TableRow key={item._id} className="min-h-[50px] hover:bg-[#F8FAFC] transition-colors">
                      ...
                      <TableCell className="px-[20px] !pl-0 !pr-[20px]">
                        <span className="text-[12px] text-[#334155] font-medium truncate">{item.sourceType}</span>
                      </TableCell>

                      <TableCell className="px-[20px] !pl-0 !pr-[20px]">
                        <span className="text-[12px] text-[#334155]">{formatDate(item.lastEdit)}</span>
                      </TableCell>
                          ...
                          {isWebPage && (
                            <TooltipProvider delayDuration={0}>
                              <Tooltip>
                                ...
                                <TooltipContent>Retrain</TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                          )}
